  ...
  (w/uniq (gu gt gi)
    `(with (,gu ,user ,gt ,t1 ,gi ,lid)
      (fulltop ,gu ,gi ,label ,title ,whence
        ...
        (pr "<center><div class='sb' style='margin: 3px 0;'><a title='Read our Privacy Policy' href='https://intelligence.org/files/PrivacyandTerms-Agentfoundations.org.pdf'>Privacy &amp; Terms</a></div></center>")
        )))
